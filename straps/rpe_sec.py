...
p1_g_mul = {
        's': 97,
        'f': (
            ([0, 3, 1232, 60940, 1653719], [0, 7, 1688, 74662, 2152987], [0, 0, 62, 5300, 291603]),
            ([0, 3, 1254, 42135, 1428624], [0, 11, 2135, 47322, 1437774], [0, 0, 83, 4248, 255461]),
            ),
        }
...
p1_g_copy = {
        's': 33,
        'f': (
            [0, 33, 1137, 16812, 145288, 852472, 3750849, 13073855, 37574146, 91573962,
                192726070, 354263297, 572852089, 818662608, 1037103082, 1166786707,
                1166799413, 1037157725, 818809139, 573166437, 354817320, 193536720,
                92561040, 38567100, 13884156, 4272048, 1107568, 237336, 40920, 5456, 528,
                33, 1],
            [0, 30, 1285, 19887, 166695, 951201, 4021599, 13567630, 38231896, 92255103,
                193295461, 354654683, 573074084, 818765733, 1037141693, 1166798076,
                1166801950, 1037158129, 818809180, 573166439, 354817320, 193536720,
                92561040, 38567100, 13884156, 4272048, 1107568, 237336, 40920, 5456, 528,
                33, 1],
            [0, 30, 1285, 19887, 166695, 951201, 4021599, 13567630, 38231896, 92255103,
                193295461, 354654683, 573074084, 818765733, 1037141693, 1166798076,
                ...
                92561040, 38567100, 13884156, 4272048, 1107568, 237336, 40920, 5456, 528,
                33, 1],
            [0, 27, 1433, 23538, 188460, 1016149, 4150387, 13760724, 38465921, 92491608,
                193496624, 354798258, 573159259, 818807160, 1037157912, 1166803059,
                1166803107, 1037158320, 818809200, 573166440, 354817320, 193536720,
                92561040, 38567100, 13884156, 4272048, 1107568, 237336, 40920, 5456, 528,
                33, 1],
            ),
        }
...
for paper_name, cg in cgs.items():
    ...
    if True:
        tikzplotlib.save(filepath="figs/{}.tex".format(paper_name),
                figure=fig,
