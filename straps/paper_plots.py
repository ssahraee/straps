...
i=0
def plot_save(fn, n_s_max=10**8, suff_thresh=1000, ds=default_ds, err=1e-6, p=default_p):
    global i
    ...
    plt.title(fname)
    secfig.plot_fig(**secfig.data_fig(fn, ds=ds, n_s_max=n_s_max, suff_thresh=suff_thresh,
        err=err, p=p))
    tikzplotlib.save(filepath='figs/{}.tex'.format(fname),
            figure=fig,
